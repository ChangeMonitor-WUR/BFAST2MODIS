...
We will work with the MODIS NDVI band within the MOD13Q1 product. More information about this MODIS product can be found [here](https://lpdaac.usgs.gov/products/modis_products_table/mod13q1). Go to the NDVI and the pixel reliability Layer information and have a look.
...
Now follow the following tutorial on getting started with [R and Rstudio](https://geoscripting-wur.github.io/Scripting4GeoIntro/#Basic_R_and_RStudio_setup).
